            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8 animate-fade-in">
                    ...
                    <p className="text-slate-600 dark:text-slate-400">
                        Sign in to your Gatau account
                    </p>
                </div>

                {/* Login Form Card */}
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 p-8 animate-slide-up">
                    {/* Error Alert */}
                    {error && (
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className="block w-full pl-10 pr-10 py-3 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent transition-all"
                                    placeholder="••••••••"
                                />
                                <button
                                    type="button"
              ...
              <span className="px-2 bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400">
                Or continue with
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-all transform hover:scale-[1.02] active:scale-[0.98]"
                        >
                            <svg className="w-5 h-5 dark:text-slate-300" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-6 p-4 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800">
                        ...
                        <div className="space-y-1 text-xs">
                            <p className="text-indigo-700 dark:text-indigo-300 flex items-center gap-2">
                                ...
                                <code className="bg-indigo-100 dark:bg-indigo-900/50 px-2 py-1 rounded font-mono">admin@gatau.com</code>
                            </p>
                            <p className="text-indigo-700 dark:text-indigo-300 flex items-center gap-2">
                                <span className="font-medium min-w-[60px]">Password:</span>
                                <code className="bg-indigo-100 dark:bg-indigo-900/50 px-2 py-1 rounded font-mono">admin123</code>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                {/* Sign Up Link */}
                <p className="mt-6 text-center text-sm text-slate-600 dark:text-slate-400 animate-fade-in">
